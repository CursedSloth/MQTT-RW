...
var connectionString = 'HostName=iotHubCloudDevVictor.azure-devices.net;SharedAccessKeyName=iothubowner;SharedAccessKey=eLM3TsfNhujVfdSVP3NdC3ega3VbtpffLWRv3R86644=';
...
var printMessage = function (message) {
  ...
  //var coords = message.body;
  //var coordsParts = coords.split(':');
  //console.log('X:' + coordsParts[0] + ' Y:' + coordsParts[1] + ' Z:' + coordsParts[2]);
